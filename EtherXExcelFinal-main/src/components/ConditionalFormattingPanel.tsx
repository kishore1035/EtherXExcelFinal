          ...
          <div className="space-y-4 py-4">
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                className="h-20 flex flex-col items-start justify-center text-left text-black"
              ...
              >
                ...
                <span className="text-xs text-gray-600">Greater than, less than, between...</span>
              </Button>
              ...
              >
                ...
                <span className="text-xs text-gray-600">Top 10, bottom 10...</span>
              </Button>
              ...
              >
                ...
                <span className="text-xs text-gray-600">Visual bars in cells</span>
              </Button>
              ...
              >
                ...
                <span className="text-xs text-gray-600">2 or 3 color gradients</span>
              </Button>
              ...
              >
                ...
                <span className="text-xs text-gray-600">Traffic lights, arrows...</span>
              </Button>
              ...
              >
                ...
                <span className="text-xs text-gray-600">Use formula to determine...</span>
              </Button>
            </div>
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <Input
                ...
                className="mt-2 bg-gradient-to-r from-[#FFFEF5] to-[#FFF9E6] border-[#FFD700] text-black"
              />
            </div>
            ...
            <div>
              ...
              <Select value={ruleType} onValueChange={(val: any) => setRuleType(val)}>
                <SelectTrigger className="mt-2 bg-white border-gray-300 text-black">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            {ruleType === 'highlight' && (
              <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {operator === 'between' && (
                    <div>
                      <Label className="text-black">And</Label>
                      <Input
                        value={value2}
                  ...
                  <div>
                    ...
                    <div className="flex gap-2 mt-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setBgColor(e.target.value)}
                        placeholder="#dbeafe"
                        className="bg-gradient-to-r from-[#FFFEF5] to-[#FFF9E6] border-[#FFD700] text-black"
                      />
                    </div>
                  </div>
                  <div>
            ...
            {ruleType === 'topBottom' && (
              <div>
                <Label className="text-black">Number of Items</Label>
                <Input
                  type="number"
                  value={topN}
            ...
            {ruleType === 'dataBars' && (
              <div>
                <Label className="text-black">Bar Color</Label>
                <div className="flex gap-2 mt-2">
                  <Input
                    type="color"
                    value={dataBarColor}
            ...
            {ruleType === 'colorScales' && (
              <>
                <div>
                  <Label className="text-black">Scale Type</Label>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    <Label className="text-black">Min Color</Label>
                    <Input
                      type="color"
                      value={minColor}
                  ...
                  {colorScaleType === '3color' && (
                    <div>
                      <Label className="text-black">Mid Color</Label>
                      <Input
                        type="color"
                        value={midColor}
                  ...
                  <div>
                    <Label className="text-black">Max Color</Label>
                    <Input
                      type="color"
                      value={maxColor}
            ...
            {ruleType === 'iconSets' && (
              <div className="p-4 bg-gradient-to-r from-[#FFFEF5] to-[#FFF9E6] border border-[#FFD700] rounded">
                <p className="text-sm text-black font-semibold mb-2">Icon Sets</p>
            ...
            {ruleType === 'customFormula' && (
              <div>
                ...
                <Input
                  ...
                  className="mt-2 font-mono bg-gradient-to-r from-[#FFFEF5] to-[#FFF9E6] border-[#FFD700] text-black"
                />
                  ...
                  >
                    <div className="flex flex-col gap-1">
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-6 w-6 p-0 text-black hover:bg-[#FFFACD]"
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-black">{getRuleDescription(rule)}</div>
                    ...
                    <div className="flex gap-1">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-8 w-8 p-0 text-black hover:bg-[#FFFACD]"
                        onClick={() => {
                          // TODO: Implement edit
                        }}
                      >
