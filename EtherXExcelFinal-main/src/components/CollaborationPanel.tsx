      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <Users className="w-6 h-6" style={{ color: isDarkMode ? '#000' : '#FFF' }} />
            </div>
            <div>
              <h2
              ...
              <p
                className="text-sm"
                style={{ color: isDarkMode ? '#FFFFFF' : 'rgba(255, 255, 255, 0.9)' }}
              >
        ...
        >
          ...
          >
            <strong style={{ color: isDarkMode ? '#FFD700' : '#FFA500' }}>
        ...
        <div className="px-6 py-3 flex gap-4">
          ...
          >
            ...
            <div className="text-xs" style={{ color: isDarkMode ? '#FFFFFF' : '#666666' }}>
              Owned Links
            </div>
          </div>
          <div
        ...
        {/* Last Refresh Time */}
        <div className="px-6 py-2 flex items-center gap-2 text-xs" style={{ color: isDarkMode ? '#FFFFFF' : '#999999' }}>
          ...
          {collaborations.length === 0 ? (
            <div className="text-center py-12">
              <Share2
                ...
                style={{ color: isDarkMode ? '#666666' : '#CCCCCC' }}
              />
              <p className="text-lg font-medium" style={{ color: isDarkMode ? '#FFFFFF' : '#666666' }}>
                No collaborations yet
              </p>
              <p className="text-sm mt-2" style={{ color: isDarkMode ? '#999999' : '#999999' }}>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <span style={{ color: isDarkMode ? '#999999' : '#666666' }}>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <UserCheck className="w-4 h-4" style={{ color: isDarkMode ? '#FFD700' : '#FFA500' }} />
                      <span
                        className="text-sm font-semibold"
                        style={{ color: isDarkMode ? '#FFD700' : '#FFA500' }}
                      >
                        Collaborators ({collab.collaborators.length})
                      </span>
                    </div>
                    {collab.collaborators.length === 0 ? (
                      <p className="text-sm italic" style={{ color: isDarkMode ? '#666666' : '#999999' }}>
                        ...
                        {collab.collaborators.map((collaborator) => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              ...
                              <p className="text-xs mt-1" style={{ color: isDarkMode ? '#666666' : '#999999' }}>
