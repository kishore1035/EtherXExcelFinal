  ...
  const menuItems = [
    {
      ...
      icon: <ArrowLeft className="w-4 h-4" style={{ color: '#000000' }} />
    },
    {
      id: 'shift-up' as DeleteAction,
      label: 'Shift Cells Up',
      icon: <ArrowUp className="w-4 h-4" style={{ color: '#000000' }} />
    },
    {
      id: 'entire-row' as DeleteAction,
      label: 'Entire Row',
      icon: <Minus className="w-4 h-4" style={{ color: '#000000' }} />
    },
    {
      id: 'entire-column' as DeleteAction,
      label: 'Entire Column',
      icon: <Minus className="w-4 h-4 rotate-90" style={{ color: '#000000' }} />
    },
    {
