...
export function ExcelSpreadsheet({ user, onLogout, onBackToHome, importedData, currentSpreadsheet }: ExcelSpreadsheetProps) {
  ...
  useEffect(() => {
    if (currentSpreadsheet) {
      ...
      if (isNewBlankSpreadsheet) {
        ...
        console.log(`🧹 Cleared autosave cache for new blank sheet: ${newId}`);
      }
