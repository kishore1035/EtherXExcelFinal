      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cn(
            ...
            "max-h-[90vh] overflow-y-auto text-black"
          )}
        >
        <DialogHeader>
          <DialogTitle className="text-black">Data Validation</DialogTitle>
        </DialogHeader>

        <Tabs defaultValue="settings" className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-white border border-gray-300">
            <TabsTrigger 
              value="settings" 
              className="text-black data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#FFFACD] data-[state=active]:to-[#FFD700]"
            >
              Settings
            </TabsTrigger>
            <TabsTrigger 
          ...
          <TabsContent value="settings" className="space-y-4 mt-4">
            <div>
              <Label className="text-black">Apply to Range</Label>
              <Input 
                value={range} 
            ...
            <div>
              <Label className="text-black">Validation Type</Label>
              <Select value={validationType} onValueChange={(v: any) => setValidationType(v)}>
                <SelectTrigger className="mt-1 text-black" style={{ background: 'linear-gradient(135deg, #FFFEF5 0%, #FFF9E6 100%)', border: '1px solid #FFD700' }}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-white" style={{ border: '1px solid #FFD700' }}>
                  <SelectItem value="wholeNumber" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Whole Number</SelectItem>
                  <SelectItem value="decimal" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Decimal Number</SelectItem>
                  <SelectItem value="list" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Dropdown List</SelectItem>
                  <SelectItem value="date" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Date</SelectItem>
                  <SelectItem value="time" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Time</SelectItem>
                  <SelectItem value="textLength" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Text Length</SelectItem>
                  <SelectItem value="custom" className="text-black data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-[#FFFACD] data-[state=checked]:to-[#FFD700] hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]">Custom Formula</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            {(validationType === 'wholeNumber' || validationType === 'decimal') && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-black">Minimum Value</Label>
                  <Input 
                    type="number"
                ...
                <div>
                  <Label className="text-black">Maximum Value</Label>
                  <Input 
                    type="number"
                    step={validationType === 'decimal' ? '0.01' : '1'}
                    value={maxValue}
            ...
            {validationType === 'list' && (
              <div>
                <Label className="text-black">Dropdown Items</Label>
                <div className="space-y-2 mt-2">
                  {listItems.map((item, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <Input value={item} readOnly className="flex-1 bg-white text-black border-gray-300" />
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => handleRemoveItem(index)}
                        className="shrink-0 bg-white text-black border border-gray-300 hover:bg-gradient-to-r hover:from-[#FFFACD] hover:to-[#FFD700]"
                      >
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input 
                    ...
                    onKeyDown={(e) => e.stopPropagation()}
                    style={{ background: 'linear-gradient(135deg, #FFFEF5 0%, #FFF9E6 100%)', border: '1px solid #FFD700' }} className="mt-1 text-black"
                  />
                </div>
                <div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-blue-900 dark:text-blue-100">Input Message</h4>
          ...
          <TabsContent value="error-alert" className="space-y-4 mt-4">
            <div>
              <Label className="text-black">Error Alert Style</Label>
              <div className="grid grid-cols-3 gap-2 mt-2">
                ...
                >
                  <Ban className="h-8 w-8 mx-auto mb-2 text-black" />
                  <div className="font-medium text-black">Stop</div>
                  <div className="text-xs text-black">Blocks entry</div>
                </button>
                <button
                  type="button"
                  ...
                  className="p-4 rounded-lg transition-all"
                >
                  <AlertTriangle className="h-8 w-8 mx-auto mb-2 text-black" />
                  <div className="font-medium text-black">Warning</div>
                  <div className="text-xs text-black">Can continue</div>
                </button>
                <button
                  type="button"
                  ...
                  className="p-4 rounded-lg transition-all"
                >
                  <Info className="h-8 w-8 mx-auto mb-2 text-black" />
                  <div className="font-medium text-black">Information</div>
                  <div className="text-xs text-black">Just informs</div>
                </button>
              </div>
            </div>
